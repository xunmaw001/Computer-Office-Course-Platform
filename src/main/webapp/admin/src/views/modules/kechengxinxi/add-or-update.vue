<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="24">  
        <el-form-item class="upload" v-if="type!='info'" label="课程文件" prop="kechengwenjian">
          <file-upload
          tip="点击上传课程文件"
          action="file/upload"
          :limit="1"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.kechengwenjian" label="课程文件" prop="kechengwenjian">
            <el-button type="text" size="small" @click="download(ruleForm.kechengwenjian)">下载</el-button>
          </el-form-item>
        </div>    
      </el-col>      
      <el-col :span="24">  
...
export default {
  ...
  methods: {
	...
	this.ruleForm.kechengneirong = this.ruleForm.kechengneirong.replace(reg,'../../../ssm04i6d/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
